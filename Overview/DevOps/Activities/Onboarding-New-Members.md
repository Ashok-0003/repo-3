...
1. Coordinate with Fahim or any Malomatia POC for revoking the access or removing the account when it is not required. Please refer to [Account Deletion Process](/Overview/DevOps/Activities/Removing-Users) for more details.