...
|func-cpd-apps-intbpa-<env>-we-01 | Function App | <env>-cdntasmu | CDN Endpoint Contributor |
|spn-cmsbpa-<env> | Service Principal | <env>-cdntasmu | CDN Endpoint Contributor |
