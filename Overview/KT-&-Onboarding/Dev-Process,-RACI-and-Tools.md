...
| 5 | Conduct unit test in Feature branch - Angular (Jasmine), C# (XUnit), Chatbot (XUnit) and update the state of user story to "Dev Complete" | Jasmine, XUnit | Developer | Dev Lead | Dev Lead | Project Manager | 
